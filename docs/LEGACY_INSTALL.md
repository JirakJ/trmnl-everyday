# Historical combined installation

This is the original combined setup. For current standalone repositories, use the [plugin directory](../README.md).
...
· [Running and scheduling](RUNNING.md)
· [Verification and current limits](VERIFICATION.md)
